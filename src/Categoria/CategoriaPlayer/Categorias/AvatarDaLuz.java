...
public class AvatarDaLuz extends CategoriaPlayer {
    public AvatarDaLuz() {
        super(
            ...
            Arrays.asList(),
            Arrays.asList(HabilidadesFactoryPlayer.JUÍZO_FINAL, HabilidadesFactoryPlayer.AURA_SUPREMA, HabilidadesFactoryPlayer.CURA_CONTINUA, HabilidadesFactoryPlayer.PURIFICACAO),
