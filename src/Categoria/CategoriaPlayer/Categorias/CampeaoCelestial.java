...
public class CampeaoCelestial extends CategoriaPlayer {
    public CampeaoCelestial() {
        super(
            ...
            Arrays.asList(),
            Arrays.asList(HabilidadesFactoryPlayer.GOLPE_CELESTIAL, HabilidadesFactoryPlayer.FORCA_SUPREMA, HabilidadesFactoryPlayer.VELOCIDADE_SUPREMA, HabilidadesFactoryPlayer.MEDO_CELESTIAL),
